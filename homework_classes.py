...
class Record:
    ...
    def add_phone(self, phone: str) -> None:
        ...
        """
        # print(f"Record Add phone, phone: {phone}", type(phone))
        # print(f"Record Add phone, self.phones: {self.phones}", type(self.phones))
        ...
        # print(f"Record Add phone, self.phones: {self.phones.phones}", type(self.phones.phones))
    ...
    def find_phone(self, phone: str) -> str:
        ...
        """
        # print(f"Record Find phone, phone: {phone = }; {type(phone)}")
        # print(f"Record Find phone, phones: {self.phones.phones}; {type(self.phones.phones)}")
        for found_phone in self.phones.phones:
            if found_phone == phone:
                # print(f"Record Find phone, found phone: {found_phone}; {type(found_phone)}")
                return found_phone
        print('Record Find phone: ')
        pprint(locals())
...
class AddressBook(UserDict):    # Клас для зберігання та управління записами.
    ...
    def add_record(self, value: Record) -> None:
        ...
        for data in self.data:
            print(f"AddressBook Add record For data: {data}; {type(data)}")
        # self.value.append(value)
        # print(f"AddressBook Add record: {self.value = }; {type(self.value)}")
        print('AddressBook Add record:')
        pprint(locals())
    ...
    def find(self, name: str) -> Record:
        ...
        """
        print(f"Address Book Find, self.data: {self.data}; {type(self.data)}")

        print('AddressBook Find:')
        pprint(locals())

        for data in self.data:

            if data.name:
                print(f"Address Book Find For(self.data) If, data.name: {data.name}", type(data.name))
                print(f"Address Book Find For(self.data) If, data: {data}", type(data))
                return data
